        ...
        <aside className='hidden xl:block'>
          <div className='sticky top-20 space-y-4'>
            <section className='celestia-card overflow-hidden'>
              <div className='celestia-orbit-thumb h-36 border-b border-border/70' />
              <div className='p-4'>
                ...
                <h2 className='text-sm font-semibold leading-snug'>Your signal will appear in this compact feed format.</h2>
                <p className='mt-2 text-xs leading-6 text-muted-foreground'>
                  Keep the title specific, add enough context, and use comma-separated topics so people can discover it.
                </p>
