          ...
          <div className='mb-4 flex flex-wrap items-end justify-between gap-3'>
            <div>
              ...
              <p className='mt-1 text-sm text-muted-foreground'>
                Signed in as {user.displayName ?? user.username}. Choose one of your communities, then add a title and
                body.
              </p>
            </div>
          </div>
            ...
            <section className='celestia-card overflow-hidden'>
              <div className='p-3'>
                ...
                <h2 className='text-sm font-semibold leading-snug'>
                  Your post will appear in this compact feed format.
                </h2>
                ...
                <div className='mt-3 flex items-center gap-3 text-xs text-muted-foreground'>
                  ...
                  <span className='inline-flex items-center gap-1'>
                    <MessageSquare className='size-3' /> 34
                  </span>
                </div>
              </div>
            </section>
